...
int main(){
    ...
    double total_cost_normal_engineering = normal_units * cost_per_specialized_engineering_unit;

    /* The printf statements that display all of the outputs required. */
    printf("Specialized Engineering units: %.1f, Cost per unit: $%.2f, Total cost: $%.2f\n", specialized_engineering_units, cost_per_normal_unit, total_cost_special_engineering);
